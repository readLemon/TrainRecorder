...
class CheckAbsentActivity : BaseActivity() {
    ...
    private val teamAbsentList = ArrayList<TeamAbsentBean.Data>()
    private val personalAbsentList = ArrayList<PersonalAbsentBean.Leave>()
    ...
    private fun initData() {
        ...
        checkAbsentViewModel.apply {
            requestPersonalData(currentBean.name)
            requestData()
    ...
    private fun initView() {
        ...
        val adapter = LeaveRecycleAdapter<TeamAbsentBean.Data>(teamAbsentList, this)
        ...
        adapter.setOnrecycleItemClikedListener(object :
            OnRecycleItemClickedListener<TeamAbsentBean.Data> {
