...
class RichEditor : ScrollView {
    ...
    constructor(context: Context, @Nullable attrs: AttributeSet, defStyleAttr: Int) : super(
        ...
        reInitHont = ta.getString(R.styleable.RichEditor_text_init_hint).toString()
        reTextColor = ta.getColor(R.styleable.RichEditor_text_color, Color.parseColor("#757575"))
    ...
    private fun addEditAtIndex(index: Int, editStr: String) {
        ...
        if (!TextUtils.isEmpty(keywords)) {
            val textStr = highlight(editStr, keywords)
     ...
     */
    private fun highlight(text: String, target: String): SpannableStringBuilder {
     ...
     * @return
     */
    private fun buidldData(): List<EditData> {
